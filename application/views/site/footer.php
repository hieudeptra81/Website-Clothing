            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="<?php echo base_url(); ?>" style="pointer-events: none;padding: 10px;background-color: white"><img src="<?php echo base_url(); ?>upload/logo6.png" alt="" class="img-responsive"></a>
                    </div>
            ...
            <div class="col-lg-12 text-center">
                <div class="footer__copyright__text">
                    ...
                    <p>Copyright ©
                        ...
                        Cảm ơn đã ghé với shop<i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" >Nhóm  7 - 70DCTT23</a>
                    </p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
